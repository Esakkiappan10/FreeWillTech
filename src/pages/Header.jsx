      ...
      */}
      ...
      >
        ...
        <motion.div variants={fadeUp} className="max-w-xl mb-10">
          <SplitText
            text="At FrontierWox Tech, we build intelligent web and mobile solutions, empower startups with tech consultation, and create bridges between education and innovation. Together, we’re shaping the future of digital transformation."
