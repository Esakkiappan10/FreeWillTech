// AboutCompany.jsx — Two-Column Layout + Option C Mockups + Premium Animations
...
export default function AboutCompany() {
  ...
  return (
    <section
      id="about"
      ref={ref}
      className="relative py-24 px-6 lg:px-12 bg-gradient-to-b from-white to-slate-50 overflow-hidden font-[Nunito]"
    >
      {/* Soft Ambient Glows */}
      ...
      <div className="max-w-[1300px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start relative z-10">
        ...
        <motion.div
          ...
          className="space-y-6"
        >
          <motion.p variants={item} className="text-[#FE861B] text-6xl font-extrabold tracking-wide">
            About Free Will
          </motion.p>
          ...
          <motion.p variants={item} className="text-slate-700 text-xl leading-relaxed max-w-md">
          ...
          <motion.p variants={item} className="text-slate-700 text-xl leading-relaxed max-w-lg">
            <strong className="text-[#FE861B]">Empowering Innovation. Enabling the Future.</strong>  
            We build intelligent web apps, mobile apps, automation solutions, and 
            help startups grow with the right technology strategy.
          </motion.p>
          ...
          <motion.p variants={item} className="text-orange-500 text-xl font-bold leading-relaxed max-w-lg">
        ...
        {/* RIGHT COLUMN (Option C Mockups + Cards) */}
        <motion.div
          variants={container}
          initial="hidden"
          animate={controls}
        ...
        >
          {services.map((svc, idx) => (
            ...
            >
              {/* Option C — Soft 3D Mockup Box */}
              <div className="relative mb-4 w-full h-[140px] rounded-xl overflow-hidden shadow-sm bg-white">
                <div className="absolute inset-0 bg-gradient-to-br from-[#E5F5FF] via-[#FFF8F2] to-[#FFFFFF]" />
                <div className="absolute right-4 bottom-4 w-[90px] h-[60px] rounded-lg 
                bg-gradient-to-br from-[#1E9CD7] to-[#FE861B] opacity-90 shadow-md" />
