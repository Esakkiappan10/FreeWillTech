...
export default function AboutCompany() {
  ...
  return (
    <section
      ref={ref}
      id="services"
      className="relative py-20 md:py-32 px-5 md:px-12 bg-slate-50 overflow-hidden font-sans"
    >
      {/* Ambient Background Blurs (Blue & Orange) */}
      <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-[#1E9CD7]/5 rounded-full blur-[100px] pointer-events-none mix-blend-multiply" />
      <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-[#FE861B]/5 rounded-full blur-[100px] pointer-events-none mix-blend-multiply" />
      ...
      <div className="max-w-[1450px] mx-auto relative z-10">
        ...
        <div className="mb-16 md:mb-24 text-center max-w-3xl mx-auto">
            ...
            >
                <span className="inline-block py-1 px-3 rounded-full bg-blue-100/50 border border-blue-200 text-[#1E9CD7] font-bold tracking-wider uppercase text-[10px] md:text-xs mb-4">
                    Our Expertise
                </span>
                ...
                <p className="text-base md:text-lg text-slate-600 leading-relaxed md:px-8">
                  From complex cloud architectures to pixel-perfect design, our comprehensive services 
                  cover every aspect of the digital lifecycle.
                </p>
            </motion.div>
        </div>
