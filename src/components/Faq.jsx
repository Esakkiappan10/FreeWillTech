    ...
    >
      ...
      <div className="w-[90%] lg:w-[85%] xl:w-[80%] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
        ...
        >
          ...
          {/* Contact Card */}
          <motion.div
            className="absolute bottom-[-40px] right-0 md:right-6 lg:right-[-10px] p-6 md:p-7 rounded-2xl bg-gradient-to-br from-[#0F172A] to-[#10243A] shadow-2xl w-[92%] sm:w-[78%] md:w-[68%] lg:w-[70%] text-white"
            variants={fadeUp(0.16)}
          >
            <h3 className="text-lg sm:text-xl font-bold leading-tight">
              Contact Us For a{" "}
              <span className="text-primary">Free Learning</span> Consultation
            </h3>

            <div className="mt-4 flex items-center gap-3 w-fit px-4 py-2 bg-gradient-to-r from-primary to-blue-700 rounded-xl shadow-md">
              <Phone className="stroke-white w-5 h-5" />
              <a href="tel:+916382503265" className="text-white font-medium text-sm sm:text-base">
                +91 63825 03265
              </a>
            </div>
          </motion.div>
        ...
        <motion.div variants={fadeUp(0.12)} initial="hidden" animate={controls}>
          ...
          <div className="flex items-center gap-3 mb-4">
            <div className="p-2 bg-primary/30 rounded-full">
              <div className="h-3 w-3 bg-primary rounded-full shadow-md" />
            </div>
            <p className="text-primary font-bold text-xs sm:text-sm uppercase tracking-wide">
              FAQ
            </p>
          </div>
          ...
          >
            <a
              href="/contact"
              className="inline-flex items-center gap-3 px-6 py-3 rounded-xl bg-gradient-to-r from-primary to-blue-700 text-white font-semibold shadow-lg hover:-translate-y-1 transition"
            >
              Get in touch
            </a>
